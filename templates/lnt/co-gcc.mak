...
#
# 	make -f co-gcc.mak \
#		CC_BIN='name of the gcc binary' \
#		CXX_BIN='name of the g++ binary' \
...
macros:
	$(ECHO) | $(GCC) -E -dM - -o lint_cmac.h
	$(ECHO) | $(GXX) -E -dM - -o lint_cppmac.h
...
int main() {\
printf( "-ss%u  ", __SIZEOF_SHORT__ );\
printf( "-si%u  ", __SIZEOF_INT__ );\
printf( "-sl%u  ", __SIZEOF_LONG__ );\
printf( "-sll%u ", __SIZEOF_LONG_LONG__ );\
printf( "-sf%u  ", __SIZEOF_FLOAT__ );\
printf( "-sd%u  ", __SIZEOF_DOUBLE__ );\
printf( "-sld%u ", __SIZEOF_LONG_DOUBLE__ );\
printf( "-sp%u  ", __SIZEOF_POINTER__ );\
printf( "-sw%u  ", __SIZEOF_WCHAR_T__ );\
}' >$(SIZE_GEN).cc
	$(GXX) -E $(SIZE_GEN).cc -o $(SIZE_GEN).ii
	g++ $(SIZE_GEN).ii -o $(SIZE_GEN)
